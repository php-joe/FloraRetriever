 ...
 */
define("EMAIL_PASSWORDRESET_FROM", "admin@floraretriever.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Flora Retriever");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for Flora Retriever");
define("EMAIL_PASSWORDRESET_CONTENT", "Please click on this link to reset your password:");

/**
 * Configuration for: verification email data
 */
define("EMAIL_VERIFICATION_FROM", "admin@floraretriever.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Flora Retriever");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for Flora Retriever");
