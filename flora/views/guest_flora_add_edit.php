...
<h3>We Care About Flora</h3></center>
  ...
  <br>
      ...
      <div class="form-group hidden">
        ...
        <textarea class="form-control" maxlength="250" rows="2" id="userLocation" name="userLocation"></textarea>
      </div>
      <div class="form-group hidden">
        <label for="weather">Weather Information:</label>
        <textarea class="form-control" maxlength="250" rows="2" id="userWeather" name="userWeather"></textarea>
      </div>
