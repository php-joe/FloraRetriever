...
<table id="listView" class="table table-striped" data-page-length='25'>
  ...
  <tr>
    ...
    <td><?= $bird->getnest() ?></td>
    <td><?= $bird->getEggs() ?></td>
    <td><a href='bird.php?action=view_bird&target=<?= $bird->getBID() ?>' class="btn btn-default">View Full Record</button></a>
  </tr>
  <?php } ?>
</tbody>
</table>
...
<br>
<br>
<center><a href='bird.php?action=add_bird' class="btn btn-default btn-lg">Add New Bird Records</button></a>
  <a href="../lib/export.php" class="btn btn-default btn-lg">Export The Database Table</button></a>
