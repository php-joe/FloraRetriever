...
<div class="container">
  ...
  <h3>We Care About Bird</h3></center>
    ...
    <form id="live_form" role="form" method="get" action="../webprotect/bird.php">
    ...
    <div class="form-group">
      ...
      <input type="text" maxlength="20" class="form-control" value="0" id="eggs" name="eggs" value="<?= $bird->getEggs() ?>" required /><br>
    </div>
